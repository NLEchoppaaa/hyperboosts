                    ...
                    >
                      <div className="group relative flex flex-col rounded-lg bg-[#FF59A2]/5 border border-[#FF8DCA]/20 hover:border-[#FF59A2]/30 backdrop-blur-sm transition-all">
                        ...
                        <div className="px-6 pt-4 pb-6">
                          <h3 className="text-xl font-semibold text-center group-hover:bg-gradient-to-r group-hover:from-[#FF8DCA] group-hover:to-[#FF59A2] group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
                            {product?.title}
                          </h3>
                          <div className="flex flex-row justify-between items-end mt-4">
                            <div className="text-3xl font-semibold bg-gradient-to-r from-[#FF8DCA] to-[#FF59A2] bg-clip-text text-transparent">
                              {`$${product?.price}`}
                            </div>
                          ...
                          <div className="w-full border-t border-[#FF8DCA]/20 my-4"></div>
                          ...
                          <div className="flex flex-col gap-2">
                            {getProductFeatures(product).map((feature, featureIndex) => (
                              <div key={featureIndex} className="flex flex-row items-start gap-2">
                                <Check size={18} className="text-[#FF8DCA] mt-0.5 shrink-0" />
