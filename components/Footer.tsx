    ...
    <Link href={href || "#"} target="_blank">
      ...
      >
        ...
        >
          ...
          <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#FF8DCA] to-[#FF59A2] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200" />
        </Button>
      </motion.div>
    </Link>
  );
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-2">
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-3 rounded-lg bg-gray-800/20 border border-gray-700 focus:border-[#FF8DCA] focus:outline-none transition-colors duration-200 text-sm"
        />
        <motion.div
        ...
        >
          <Button 
            type="submit" 
            className="bg-gradient-to-r from-[#FF8DCA] to-[#FF59A2] hover:from-[#FF8DCA]/80 hover:to-[#FF59A2]/80 text-white px-6 py-2 rounded-md transition-all duration-200 shadow-lg hover:shadow-[#FF59A2]/25"
          >
          ...
          <div className="flex flex-col gap-6 max-w-xl">
            <Link href="/" className="inline-flex">
              ...
              >
                ...
                />
                <span className="text-2xl font-bold PoseidonFont bg-gradient-to-r from-[#FF8DCA] to-[#FF59A2] bg-clip-text text-transparent">
                  Hyper Boosts
                </span>
              </motion.div>
            </Link>
            ...
            <nav className="flex flex-col gap-2">
              {LandingPageLinks?.map((link: QuickLink, index: number) => (
                ...
                >
                  ...
                  >
                    <ChevronRight className="w-4 h-4 group-hover:text-[#FF8DCA] transition-colors duration-200" />
